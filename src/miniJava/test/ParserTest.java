...
public class ParserTest {
	...
	public void test() {
		...
		checkParse("int[] i = new int();", WrapperType.FUNCTION, false);
		checkParse("int i = new String();", WrapperType.FUNCTION, true);
		checkParse("String i = new String(1);", WrapperType.FUNCTION, false);
		checkParse("boolean[] i = new boolean[];", WrapperType.FUNCTION, false);
		checkParse("boolean[] i = new boolean[5];", WrapperType.FUNCTION, false);
		checkParse("int[] i = new int[];", WrapperType.FUNCTION, false);
		checkParse("String[] s = new String[];", WrapperType.FUNCTION, false);
		checkParse("int[] i = new int[2];", WrapperType.FUNCTION, true);
		checkParse("String[] s = new String[2];", WrapperType.FUNCTION, true);
